...
require (
	...
	github.com/cockroachdb/pebble v0.0.0-20220726144858-a78491c0086f // indirect
	...
	github.com/ipni/go-indexer-core v0.7.1-0.20230122165842-8feed957168a // indirect
